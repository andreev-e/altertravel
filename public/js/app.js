...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".izbr").click(function (e) {
    e.preventDefault();
    izbrannoe(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data("pois_id"));
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('fa-star-o');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('starred');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('fa-star');
  });
  var izbr = readCookie('izbr');
  var izbr_arr = izbr.split('\|');

  for (var i = 0; i < izbr_arr.length; i++) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#izbr' + izbr_arr[i]).toggleClass('fa-star-o');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#izbr' + izbr_arr[i]).toggleClass('starred');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#izbr' + izbr_arr[i]).toggleClass('fa-star');
  }
});
